...
public class MozartTrioWaltzDiceGame extends AComposer {
	...
	public MozartTrioWaltzDiceGame(File f) throws IOException {		
		super(f);
	}
	...
	public static void main(String[] args) throws IOException, InvalidMidiDataException {
		...
		AComposer composer = new MozartTrioWaltzDiceGame(f);
